...
public class CustomProgressBar extends View {
    ...
    private int mProgressDescBgColor;
    private int mProgressDescBgAllColor;
    private int mMax;
    ...
    private int DEFAULT_RADIUS = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics());
    ...
    private int DEFAULT_PROGRESS_DESC_BG_COLOR = Color.parseColor("#FFFFFF");
    private int DEFAULT_PROGRESS_DESC_BG_ALL_COLOR = Color.parseColor("#FFFFFF");
    ...
    public CustomProgressBar(Context context, AttributeSet attrs,
        ...
        try {
            ...
            mProgressDescBgColor = a.getColor(
                    R.styleable.CustomProgressBar_progressDescBgColor,
                    DEFAULT_PROGRESS_DESC_BG_COLOR);
             mProgressDescBgAllColor = a.getColor(
                    R.styleable.CustomProgressBar_progressDescBgAllColor,
                     DEFAULT_PROGRESS_DESC_BG_ALL_COLOR);
    ...
    private void drawBorder(Canvas canvas) {
        ...
        mPaint.setColor(mProgressDescBgAllColor);
    ...
    private void drawProgressBg(Canvas canvas) {
        ...
        mPaint.setAntiAlias(true);
        mPaint.setColor(mProgressDescBgColor);
        mPaint.setStrokeWidth(mBorderWidth);
