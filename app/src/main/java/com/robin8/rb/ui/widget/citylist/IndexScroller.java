...
public class IndexScroller {
    ...
    private int indexbarContainerBgColor;
    private int indexPaintColor;
    /**
    ...
    // index container
    private int indexbarContainerBgColorId = R.color.transparent;
    private int indexPaintColorId = R.color.sub_gray_custom; // color for section title
    ...
    public IndexScroller(Context context, ListView lv) {
        ...
        indexbarContainerBgColor = context.getResources().getColor(indexbarContainerBgColorId);
        indexPaintColor = context.getResources().getColor(indexPaintColorId);
        mListView = lv;
...
//            drawIndexBarContainer(canvas);
    ...
    public int getIndexbarContainerBgColorId() {
        return indexbarContainerBgColorId;
    }

    public void setIndexbarContainerBgColorId(int indexbarContainerBgColorId) {
        this.indexbarContainerBgColorId = indexbarContainerBgColorId;
    }
    ...
    public void setIndexPaintColor(int indexPaintColor) {
        this.indexPaintColor = context.getResources().getColor(indexPaintColor);
    }
