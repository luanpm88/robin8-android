...
public class SlideDetailsLayout extends ViewGroup {
    ...
    public SlideDetailsLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlideDetailsLayout,
                defStyleAttr, 0);
    ...
    protected LayoutParams generateDefaultLayoutParams() {
        return new MarginLayoutParams(MarginLayoutParams.WRAP_CONTENT, MarginLayoutParams
                .WRAP_CONTENT);
    }
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
//                    if (DEBUG) {
                    Log.d(this.getClass().getSimpleName(), "intercept, child can scroll " +
                            "vertically, do not intercept");
//                    }
                } else {
                    ...
                    //TODO bug scrollview上拉时触摸事件被拦截
                    System.out.println("yDiffabs:" + yDiffabs);
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        Log.d(this.getClass().getSimpleName(), "intercept, intercept events");
                    }
                }
                break;
            }
    ...
    private void finishTouchEvent() {
        ...
        Log.v(this.getClass().getSimpleName(), "finish, offset: " + offset + ", percent: " +
                percent + ", yVelocity: " +
                yVelocity);
    ...
    /**
     * When pulling, target view changed by the panel status. If panel opened, the target is
     * behind view.
...
//                if (child instanceof PullToRefreshScrollView.InternalScrollViewSDK9) {
//                    result = !((PullToRefreshScrollView.InternalScrollViewSDK9) child).isBottom();
//                }
//                else
