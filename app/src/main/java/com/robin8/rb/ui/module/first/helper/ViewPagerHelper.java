package com.robin8.rb.ui.module.first.helper;
...
import com.robin8.rb.ui.module.first.adapter.ImagePagerAdapter;
import com.robin8.rb.ui.module.first.adapter.NewBigVRecyclerAdapter;
import com.robin8.rb.ui.module.first.adapter.TagItemPagerAdapter;
...
public class ViewPagerHelper {
    ...
    public void updateAutoVp(AutoScrollViewPager mAutoScrollViewPager, LinearLayout mLinearLayout, List<BannerBean> bannerList) {
        ...
        mAutoScrollViewPager.setAdapter(new com.robin8.rb.ui.adapter.ImagePagerAdapter(mActivity, bannerList).setInfiniteLoop(true));
        mAutoScrollViewPager.setOnPageChangeListener(new MyOnPageChangeListener(size, mLinearLayout));
        if (size != 1) {
            mAutoScrollViewPager.setInterval(5000);
            mAutoScrollViewPager.startAutoScroll();
