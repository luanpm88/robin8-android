...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
  ...
  // Draw a progress by sub class
    protected abstract void drawProgressSecond(LinearLayout layoutProgress, float max, float progress, float totalWidth,
                                               int radiusBg, int padding, int colorProgress, boolean isReverse);
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        radiusBg = (int) typedArray.getDimension(R.styleable.RoundCornerProgress_rcRadiusBg, dp2px(DEFAULT_PROGRESS_RADIUS));
    ...
    private void drawSecondaryProgress() {
        drawProgressSecond(layoutSecondaryProgress, max, secondaryProgress, totalWidth, radiusBg, padding, colorSecondaryProgress, isReverse);
    }
