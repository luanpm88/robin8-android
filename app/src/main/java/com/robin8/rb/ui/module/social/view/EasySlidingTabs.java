...
package com.robin8.rb.ui.module.social.view;
...
//        tab.setPadding(2, 0, 2, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.indicatorDrawable != null) {
            ...
            canvas.drawRect(lineLeft + this.mMyUnderlinePadding*5, height - this.indicatorHeight, lineRight - this.mMyUnderlinePadding*5, height, this.rectPaint);
        }
