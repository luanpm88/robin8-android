...
public class ArticleListsAdapter extends BaseRecyclerAdapter {
    ...
    public ArticleListsAdapter(List<Object> list, Context context) {
        this.mDataList = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem) {
        ...
        if (viewType == TYPE_REFRESH) {
            view = mLayoutInflater.inflate(R.layout.article_lists_refresh_item, null);
        } else if (viewType == TYPE_BIG) {
            view = mLayoutInflater.inflate(R.layout.article_lists_big_item, null);
        } else {
            view = mLayoutInflater.inflate(R.layout.article_lists_item, null);
        }
