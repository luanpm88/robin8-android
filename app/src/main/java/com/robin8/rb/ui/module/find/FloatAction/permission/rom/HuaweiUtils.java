 ...
 */
package com.robin8.rb.ui.module.find.FloatAction.permission.rom;
...
//   ComponentName comp = new ComponentName("com.android.settings","com.android.settings.permission.single_app_activity");//此处可跳转到指定app对应的权限管理页面，但是需要相关权限，未解决
            ...
            LogUtil.LogShitou(TAG, Log.getStackTraceString(e));
        }
    }
    ...
    private static boolean checkOp(Context context, int op) {
        ...
        if (version >= 19) {
            ...
            LogUtil.LogShitou(TAG, "Below API 19 cannot invoke!");
        }
        return false;
    }
}
