package com.robin8.rb.ui.module.find.view;
...
import com.robin8.rb.ui.module.find.adapter.NineGridViewAdapter;
...
public class NineGridView extends ViewGroup {
    ...
    private int singleImageSize = 160;              // 单张图片时的最大大小,单位dp
...
//              //  gridWidth = gridHeight = (totalWidth - gridSpacing * 2) / 2;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            BitmapUtil.loadFindImage(getContext().getApplicationContext(), mImageInfo.get(i).getThumbnailUrl(), childrenView,true);
