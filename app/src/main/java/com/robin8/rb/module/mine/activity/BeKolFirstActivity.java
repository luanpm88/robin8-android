...
public class BeKolFirstActivity extends BaseActivity {
    ...
    private static final int ITEM_JOB = 5;//职业
    private static final int ITEM_INTEREST = 4;//兴趣
    private static final int ITEM_SOCIAL_ACCOUNT = 6;//社交账号

    private static final int ITEM_DESC = 7;//简介
