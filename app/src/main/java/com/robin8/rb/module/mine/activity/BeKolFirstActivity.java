...
public class BeKolFirstActivity extends BaseActivity {
    ...
    private static final int ITEM_GENDER = 3;//性别
    private static final int ITEM_AGE = 4;//年龄
    private static final int ITEM_JOB = 6;//职业
    private static final int ITEM_INTEREST = 5;//兴趣
    private static final int ITEM_SOCIAL_ACCOUNT = 7;//社交账号

    private static final int ITEM_DESC = 8;//简介
    private static final int ITEM_Phone = 2;//简介
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (getItemViewType(position)) {
                ...
                case TYPE_NORMAL:
                    ...
                    tvName.setText(item.name);
                    if (item.name.equals(getString(R.string.user_phone_num))){
            ...
            if (isShow==true && position !=ITEM_Phone){
