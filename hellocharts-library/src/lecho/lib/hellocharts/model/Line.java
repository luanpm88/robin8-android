...
public class Line {
    ...
    private int pointHilightColor=UNINITIALIZED;
    ...
    public Line setPointHilightColor(int pointHilightColor) {
        this.pointHilightColor = pointHilightColor;
        if (pointHilightColor == UNINITIALIZED) {
            this.darkenColor = ChartUtils.darkenColor(color);
        } else {
            this.darkenColor = ChartUtils.darkenColor(pointColor);
        }
    ...
    public int getPointHilightColor() {
        return pointHilightColor;
    }
