...
/**
 * Single axis model. By default axis is auto-generated. Use {@link #setAutoGenerated(boolean)}
 * to disable axis values
 * generation and set values manually using
 * {@link #setValues(List)}. If Axis is auto-generated {@link #setValues(List)}
 * will be ignored but if you set some values Axis will switch to manual mode. Change how axis
 * labels are displayed by
 * changing formatter {@link #setFormatter(lecho.lib.hellocharts.formatter.AxisValueFormatter)}.
 * Axis can have a name
 * that should be displayed next to
 * labels(that depends on renderer implementation), you can change name using
 * {@link #setName(String)}, by default axis
...
public class Axis {
    ...
    private boolean drawVirtualLine = false;

    public boolean isDrawVirtualLine() {
        return drawVirtualLine;
    }

    /**
     * 必须先调用setHaveLine(true)
     *
     * @param drawVirtualLine
     */
    public void setDrawVirtualLine(boolean drawVirtualLine) {
        this.drawVirtualLine = drawVirtualLine;
    }
     ...
     */
    public static Axis generateAxisFromCollection(List<Float> axisValues, List<String>
            axisValuesLabels) {
    ...
    /**
     * Set to true if you want axis values to be drawn inside chart area(axis name still will be
     * drawn outside), by
    ...
    /**
     * Set true if you want to draw separation line for this axis, set false to hide separation
     * line, by default true.
     */
