...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            View inflate = LayoutInflater.from(context).inflate(mPickerOptions.layoutRes, contentContainer);

            //顶部标题
            TextView tvTitle = (TextView)inflate.findViewById(R.id.tvTitle);
           // RelativeLayout my_rv_top_bar = (RelativeLayout)inflate.findViewById(R.id.my_title_top_bar_xx);
         ...
         //   my_rv_top_bar.setBackgroundColor(mPickerOptions.bgColorTitle);
