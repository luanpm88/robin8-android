...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    public static final int SMOOTH_SCROLL_LONG_DURATION_MS = 750;
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isReadyForPull()) {
                    ...
                    if (absDiff > mTouchSlop && (!mFilterTouchEvents || absDiff > Math.abs
                            (oppositeDiff))) {
     ...
     */
    protected LoadingLayoutProxy createLoadingLayoutProxy(final boolean includeStart, final
    boolean includeEnd) {
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        addViewInternal(mRefreshableViewWrapper, new LinearLayout.LayoutParams(LayoutParams
                .MATCH_PARENT,
